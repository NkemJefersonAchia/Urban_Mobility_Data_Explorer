...
async function initializeApp() {
    try {
        ...
        // Change Promise.all to load them individually so one crash doesn't kill the app
        loadStatistics().catch(e => console.error("Stats failed", e));
        loadHourlyAnalysis().catch(e => console.error("Hourly failed", e));
        loadBoroughAnalysis().catch(e => console.error("Borough failed", e));
        loadPopularRoutes().catch(e => console.error("Routes failed", e));
        loadPaymentAnalysis().catch(e => console.error("Payment failed", e));
        loadWeekendComparison().catch(e => console.error("Weekend failed", e));
